...
<h2><a href="./AddNewProduct.jsp?loggedInAdmin=<%=adminname%>">Add New Product</a></h2>
<br>
	<div align="center">
				...
				<c:forEach var="coll" items="${res.rows}">
					...
					<c:if test="${fn:containsIgnoreCase(pn, entered_pname)}">
						<tr>
							...
							<td><a href="./UpdateProduct.jsp?loggedInAdmin=<%=adminname%>&prodSrNum=${coll.ProductSerialNumber}">Update</a></td>				
						</tr>
					</c:if>
				</c:forEach>
			</table>
